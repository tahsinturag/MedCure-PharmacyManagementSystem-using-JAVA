...
public class Selling extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(93, 227, 29));
        ...
        taBill.setRows(5);
        taBill.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                taBillMouseClicked(evt);
            }
        });
        ...
        jButton1.setText("Online Service");
...
//                String id = tbBillId.getText();
    ...
    private void btnAddBillMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddBillMouseClicked
        ...
        else
        {
           ...
           if (i == 1) 
           {
               taBill.setText(taBill.getText()+"                 ********************************MedCure********************************\n\n  "
...
//        tbBillId.setText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
        browser.browse (new URI("https://sites.google.com/aust.edu/medcure-onlineservice/home"));
        }
    ...
    private void taBillMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_taBillMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_taBillMouseClicked
