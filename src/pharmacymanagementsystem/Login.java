...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbUserId.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbUserIdMouseClicked(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(tbPassword, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabel5)
                        .addGap(18, 18, 18)
                        .addComponent(tbUserId, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addGap(49, 49, 49)
        ...
        jPanel1.setBackground(new java.awt.Color(93, 227, 29));
    ...
    private void btnLoginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLoginMouseClicked
        ...
        String query = "select * from user1.agents where name = '" + tbUserId.getText() + "' and password = '" + tbPassword.getText() + "'";
        
        try {
                
            conn = DriverManager.getConnection("jdbc:derby://localhost:1527/pharmacy","user1","12345");
    ...
    private void tbUserIdMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbUserIdMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tbUserIdMouseClicked
